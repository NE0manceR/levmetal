...
define('SITE_EMAIL', 'info@levmetal'); // Від даної пошти сайт відправляє листи
define('SYS_PASSWORD', '86300a25c280'); // Сіль для кешування критичних даних (паролі)
...
$_SESSION['all_languages'] = array('uk'); // Список всіх  мов в масиві, перша мова - мова по замовчуванню
